# carregamento-de-midia Specification
...
A tela de carregamento SHALL concluir dentro de um tempo previsível independente da rede,
porque nenhuma mídia é buscada durante ela — a busca de trilhas fica para o momento em que
a cena que as usa começa, coberto pelo requisito de carregamento sob demanda.

#### Scenario: Tempo máximo da tela de carregamento

- **WHEN** a página é aberta, inclusive sem qualquer conexão de rede
- **THEN** a tela de carregamento conclui em no máximo 3 segundos
- **AND** o jogo fica jogável em seguida

#### Scenario: Conclusão independe de mídia

- **WHEN** a tela de carregamento está em andamento
- **THEN** nenhuma requisição de rede de mídia é disparada por ela
